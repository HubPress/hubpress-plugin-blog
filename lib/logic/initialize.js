...
function initialize(opts) {
  return _fires2.default.fireRequestTheme(opts).then(function (updatedOpts) {
    ...
    if (localStorage.getItem('hubpress:sync')) return _fires2.default.fireRequestLocalPosts(updatedOpts).then(function (_updatedOpts) {
      return _fires2.default.fireReceiveLocalPosts(_updatedOpts);
    });
